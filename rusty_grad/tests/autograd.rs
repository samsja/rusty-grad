...
fn test_double_add() {
    ...
    assert_eq!(x.borrow().grad, array!([2.0]));
}
...
fn test_simple_two_stage_autograd() {
    ...
    assert_eq!(x.borrow().grad, array!([11.0]));
    assert_eq!(y.borrow().grad, array!([3.0]));
}
...
fn test_complexautograd_1() {
    ...
    assert_eq!(x.borrow().grad, array!([145.0]));
    assert_eq!(y.borrow().grad, array!([-385.0]));
}
...
fn test_complexautograd_2() {
    ...
    assert_eq!(x.borrow().grad, array!([10.0]));
    assert_eq!(y.borrow().grad, array!([10.0]));
}
